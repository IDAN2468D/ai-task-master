...
import { Rocket, Mail, Lock, ArrowRight, Zap, Eye, EyeOff } from 'lucide-react';
...
export default function LoginPage() {
    ...
    return (
        <main className="min-h-screen flex items-center justify-center px-6 py-20 relative overflow-hidden">
            {/* Background Effects */}
            <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#FF00E5]/8 blur-[150px] rounded-full pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[#4318FF]/10 blur-[120px] rounded-full pointer-events-none" />
            ...
            >
                ...
                <div className="vibrant-card p-8 md:p-10">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-slate-500 font-medium">Sign in to continue your workflow</p>
                    </div>
