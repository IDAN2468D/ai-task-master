...
import { User, Sparkles, Bell, Shield, Paintbrush, MonitorSmartphone, Mail, CheckCircle2, LogOut, CreditCard } from 'lucide-react';
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 md:col-span-2">
                    ...
                    <div className="relative">
                        ...
                        <input type="email" defaultValue={user.email} className="w-full pl-12 pr-5 py-4 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-white/10 rounded-2xl focus:border-[#4318FF] text-slate-800 dark:text-white font-bold text-sm focus:outline-none transition-colors shadow-inner" />
                    </div>
                </div>
            </div>
